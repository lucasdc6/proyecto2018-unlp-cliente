<template>
  <div>
    <div class="form">
      ...
      <div class="field">
        <input v-model="query.firstName" placeholder="Nombre"/>
        <input v-model="query.lastName" placeholder="Apellido"/>
        <input v-model="query.email" placeholder="Correo"/>
      </div>
      <div class="field">
        <textarea v-model="query.description" placeholder="Descripción"/>

      </div>
      <div class="field">
        <select v-model="query.category" v-for="category in categories" :key="category.id">
          <option disabled value="">Seleccione una categoría</option>
          <option :value="category.id">{{category.name}}</option>
        </select>
      </div>
      <div class="field">
        <button v-on:click="handleSubmit">Guardar</button>
        <button v-on:click="handleClear">Limpiar</button>
      </div>
    </div>
  </div>
</template>
